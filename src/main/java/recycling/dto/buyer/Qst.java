...
public class Qst {
	...
	public Qst(String qstCode, int ctQstNo, String prdCode, String bCode, String qstTitle, String qstContent,
			String qstName, String qstEmail, String qstDate, int qstHit) {
	...
	public String toString() {
		return "Qst [qstCode=" + qstCode + ", ctQstNo=" + ctQstNo + ", prdCode=" + prdCode + ", bCode=" + bCode
