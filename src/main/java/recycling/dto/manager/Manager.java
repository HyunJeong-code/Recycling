...
public class Manager {
	...
	public Manager(String mgrCode, int deptno, String mgrId, String mgrPw, String mgrName, String mgrPhone,
	...
	public String toString() {
		return "Manager [mgrCode=" + mgrCode + ", deptno=" + deptno + ", mgrId=" + mgrId + ", mgrPw=" + mgrPw
