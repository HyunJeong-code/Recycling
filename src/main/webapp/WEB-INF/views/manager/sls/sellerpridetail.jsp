                        ...
                        <div id="info">
                            <table border="1">
                                ...
                                <tr>
                                    ...
                                    <td><button><a href="/manager/sls/rptseller?sCode=${seller.S_CODE}">신고 조회</a></button></td>
                                </tr>
                                <tr>
                                    <th>총 신고 횟수</th>
                                    <td colspan="2">${rptCnt}</td>
                                    <td><button><a href="/manager/sls/sellinglist?sCode=${seller.S_CODE }">판매-관리 조회</a></button></td>
                                </tr>
                            </table>
                        </div> <!-- info End -->
                    </div> <!-- main End -->
