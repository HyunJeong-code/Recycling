...
<div class="full">
	<div class="wrap">
		...
		<form action="./upcyform" method="post" enctype="multipart/form-data">
			...
			<input type="text" id="price" name="price"><span>원</span><br>
			
			<label for="prdFee">배송비</label>
			<input type="text" id="prdFee" name="prdFee"><span>원</span><br>
			
			<label for="prdCnt">수량</label>
			<input type="text" id="prdCnt" name="prdCnt"><span>개</span><br>
