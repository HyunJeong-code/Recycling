        ...
        if(rsp.success){
            $.ajax({
                ...
                , data: {
                    ...
                    resName: $("#resName").val(), //(입력)
                    resPhone: $("#resPhone").val(), //(입력)
                    resEmail: $("#resEmail").val(),
                    resCnt: $("#resCnt").val(),
                    resPrice: $("#resPrice").val()
                    //$("#resPrice").attr("data-date")
//                     resSum: rsp.amount
//                     resTime: ${expSch.schNo}.attr("data-date"),
//                     resDate: ${expSch.schDate},
